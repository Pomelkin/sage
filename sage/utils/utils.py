...
def _draw_distributions_with_spines(
    ...
    axes[row][column].hist(
        reference_values, bins=20, ec="black", fc="red", label="Reference", density=True
    )
    axes[row][column].hist(
        actual_values,
        bins=20,
...
def draw_and_save_errors_distributions_comparison_charts(
    ...
    """
    # Imported lazily so that the base install (spelling corruption only)
    # does not require matplotlib: install sage[charts] to use this helper.
    ...
    _draw_distributions_with_spines(
        ...
        1,
        0,
        actual_stats["insertion"]["rel"],
        reference_stats["insertion"]["rel"],
    ...
    _draw_distributions_with_spines(
        ...
        1,
        1,
        actual_stats["deletion"]["rel"],
        reference_stats["deletion"]["rel"],
    ...
    _draw_distributions_with_spines(
        ...
        2,
        0,
        actual_stats["substitution"]["rel"],
        reference_stats["substitution"]["rel"],
    ...
    _draw_distributions_with_spines(
        ...
        2,
        1,
        actual_stats["transposition"]["rel"],
        reference_stats["transposition"]["rel"],
    ...
    _draw_distributions_with_spines(
        ...
        3,
        0,
        actual_stats["missing_separator"]["rel"],
        reference_stats["missing_separator"]["rel"],
    ...
    _draw_distributions_with_spines(
        ...
        3,
        1,
        actual_stats["extra_separator"]["rel"],
        reference_stats["extra_separator"]["rel"],
    ...
    ax[0][1].barh(
        ids + width, list(d_ref.values()), width, color="red", label="Reference"
    )
